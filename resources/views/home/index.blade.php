            ...
            <div class="row justify-content-center g-4">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="lk-stat-card">
                        <div class="lk-stat-card__icon"><i class="fa fa-check-circle"></i></div>
                        <h2 class="timer count-title count-number lk-stat-card__number" data-to="{{ $timDiterima }}"
                            data-speed="1500">0</h2>
                        <p class="lk-stat-card__label">Tim Diterima</p>
                    </div>
                </div>

                <div class="col-sm-6 col-md-4">
                    <div class="lk-stat-card">
                        <div class="lk-stat-card__icon"><i class="fa fa-users"></i></div>
                        <h2 class="timer count-title count-number lk-stat-card__number" data-to="{{ $jumlahPeserta }}"
                            data-speed="1500">0</h2>
                        <p class="lk-stat-card__label">Jumlah Peserta</p>
                    </div>
                </div>

                <div class="col-sm-6 col-md-4">
                    <div class="lk-stat-card">
                        <div class="lk-stat-card__icon"><i class="fa fa-clock"></i></div>
                        <h2 class="timer count-title count-number lk-stat-card__number" data-to="{{ $timMenungguJadwal }}"
                            data-speed="1500">0</h2>
                        <p class="lk-stat-card__label">Tim Menunggu Jadwal</p>
                    </div>
                </div>
...
============================================================ --}}
    <div class="lk-juara">
        <div class="container">
                    ...
                    @foreach ($juaras->take(3) as $juara)
                        <li class="nav-item" role="presentation">
                            <button class="lk-juara__tab-btn {{ $loop->first ? 'active' : '' }}"
                                id="tab-{{ $juara->id }}" data-bs-toggle="tab"
                                data-bs-target="#content-{{ $juara->id }}" type="button" role="tab"
            ...
            <div class="tab-content" id="myTabContent">
                @foreach ($juaras->take(3) as $juara)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="content-{{ $juara->id }}"
                        role="tabpanel" aria-labelledby="tab-{{ $juara->id }}">
                        ...
                        <div class="row align-items-stretch g-3">
                            ...
                            <div class="col-lg-5 d-flex">
                                <div class="lk-juara__img-wrap w-100">
                                    <img src="{{ asset('storage/' . $juara->gambar) }}" alt="{{ $juara->nama_sekolah }}"
                                        class="lk-juara__img">
                            ...
                            <div class="col-lg-4 d-flex">
                                <div class="lk-info-card w-100">
                                    ...
                                    <div class="lk-info-card__body">
                                        ...
                                        <div class="lk-info-row"
                                            style="border-bottom:none; flex-direction:column; align-items:flex-start; gap:.4rem;">
    ...
    <style>
        ...
        .lk-juara__img-wrap:hover .lk-juara__img {
        ...
        <div class="container">
            <div class="lk-cta__inner">
                <div class="lk-cta__text">
                    <span class="lk-section-label"
                        style="color:rgba(255,255,255,.65); border-color:rgba(255,255,255,.4);">LKBB Komando 2025</span>
