        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.kelola-informasi.hero') }}" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-lg"
                                        value="{{ $informasi->title ?? '' }}" placeholder="Masukkan judul halaman">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($informasi->background)
                                        <div class="mt-3">
                                            <img src="{{ Storage::url($informasi->background) }}" class="img-thumbnail"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" rows="3" class="form-control" placeholder="Masukkan deskripsi halaman">{{ $informasi->description ?? '' }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="modal fade" id="updateBiodata{{ $bio->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow">
                                            ...
                                            <form action="{{ route('admin.kelola-informasi.biodata', $bio->id) }}"
                                ...
                                <tbody>
                                    @forelse($dokumen as $doc)
                                        <tr>
                                            <td>
                                                @if ($doc->thumbnail)
                                                    <img src="{{ Storage::url($doc->thumbnail) }}" class="img-thumbnail"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form
                                                    action="{{ route('admin.kelola-informasi.dokumen.delete', $doc->id) }}"
                                        ...
                                        <div class="modal fade" id="updateDokumen{{ $doc->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.kelola-informasi.dokumen.update', $doc->id) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body p-4">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <small class="text-muted">
                                                                    ...
                                                                    Hanya file <strong>PDF</strong> yang diterima. Maks.
                                                                    10MB.
                                                                </small>
                                                            </div>
                                                        </div>
            ...
            <div class="modal fade" id="addDokumenModal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <form action="{{ route('admin.kelola-informasi.dokumen.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body p-4">
                                <div class="mb-3">
                                ...
                                <tbody>
                                    @forelse($history as $h)
                                        <tr>
                                            <td>
                                                @if ($h->image)
                                                    <img src="{{ Storage::url($h->image) }}" class="rounded"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form
                                                    action="{{ route('admin.kelola-informasi.history.delete', $h->id) }}"
                                                    method="POST" class="d-inline"
                                                    onsubmit="return confirm('Yakin ingin menghapus?')">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="modal fade" id="updateHistory{{ $h->id }}" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.kelola-informasi.history.update', $h->id) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body p-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="nama_sekolah" class="form-select"
                                                                    onchange="updateKotaEdit(this, '{{ $h->id }}')">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="kota"
                                                                    id="kota_edit_{{ $h->id }}"
                                                                    class="form-control" value="{{ $h->kota }}"
                                                                    readonly>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-semibold">Deskripsi</label>
            ...
            <div class="modal fade" id="addHistoryModal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <form action="{{ route('admin.kelola-informasi.history.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body p-4">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Nama Sekolah</label>
                                    <select name="nama_sekolah" id="nama_sekolah" class="form-select"
                                        onchange="updateKota(this)" required>
