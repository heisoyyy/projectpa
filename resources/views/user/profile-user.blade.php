            ...
            <div class="rounded p-4 shadow-sm h-100">
                ...
                <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_sekolah" value="{{ old('nama_sekolah',$user->nama_sekolah) }}" class="form-control" readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @endif
                        <input type="file" name="foto_surat_izin" class="form-control" readonly>
                    </div>

                    <!-- Status -->
                        <div class="mb-3">
                            <label class="form-label">Status Tim</label><br>
                            @if($teamStatus == 'verified')
                            <span class="badge bg-success">Terverifikasi</span>
                            @elseif($teamStatus == 'revisi')
